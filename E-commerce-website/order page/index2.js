      ...
      productDiv.innerHTML += `
        <div class="product-grid">
          <div class="productItems">
            ...
            <div class="btn_show">
              <button type="button" class="atc-btn" onclick="addToOrder(${element.id}, '${element.title}', ${element.price})">
...
function addToOrder(id, title, price) {
    ...
    if (!existingOrder) {
        orders.push({ id, title, price });
        localStorage.setItem('orders', JSON.stringify(orders));
    }

    window.location.href = '../order page/order_page.html'; // Redirect to order page
}
